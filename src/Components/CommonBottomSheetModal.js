 ...
 * @returns
 */
const CommonBottomSheetModal = ({ visible = false, enableContentPanningGesture = false, onOpen, onClosing, onClosed, onIndexChanged, title = "", snapPoints, index = 0, closable = true, children }) => {
