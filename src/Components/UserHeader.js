...
const UserHeader = () => {
    ...
    return <Pressable className="flex flex-row justify-start items-center " onPress={() => {
        ...
        <View className="flex justify-center items-start pl-[6px]">
            <Text className="text-white font-extrabold text-lg" style={{ lineHeight: 24 }}>{userInfo.name}</Text>
            <View className="flex flex-row items-center justify-center">
                <Text className="text-white text-sm" style={{ lineHeight: 14 }}>{stateStr}</Text>
                <Ionicons
